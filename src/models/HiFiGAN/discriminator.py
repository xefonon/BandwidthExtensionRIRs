...
class MelganDiscriminator(torch.nn.Module):
    def __init__(self, use_spectral_norm=False):
        ...
        self.convs = nn.ModuleList([
            ...
            norm_f(Conv1d(1024, 1024, 5, 1, groups=1, padding=20)),
            # norm_f(Conv1d(1024, 1, 3, 1, padding=2)),
        ])
...
class Down2d(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, kernel, stride, padding):
        ...
        self.n1 = nn.BatchNorm2d(out_channel)
        ...
        self.n2 = nn.BatchNorm2d(out_channel)
...
class SpecDiscriminator(nn.Module):
    ...
    def __init__(self):
        ...
        # self.discriminators = nn.ModuleList([
        #     Down2d(1, 32, (7, 7), (1, 2), (1, 4)),
        #     Down2d(32, 32, (4, 4), (1, 2), (1, 3)),
        #     Down2d(32, 32, (4, 4), (1, 2), (1, 3)),
        #     Down2d(32, 32, (4, 4), (1, 2), (1, 2)),
        # ])
        # self.conv = nn.Conv2d(32, 1, (15, 5), (32, 1), (0, 2))
        # self.pool = nn.AvgPool2d((1, 2))
        self.discriminators = nn.ModuleList([
            Down2d(1, 32, (7, 9), (1, 1), (1, 4)),
            Down2d(32, 32, (5, 8), (1, 2), (1, 3)),
            Down2d(32, 32, (4, 8), (2, 2), (1, 3)),
            Down2d(32, 32, (4, 8), (2, 2), (1, 2)),
        ])
